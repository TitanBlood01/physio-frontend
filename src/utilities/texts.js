...
export const aboutUsTexts = {
    title: "¿Quiénes somos?",
    vision: `Ser una  empresa dedicada  a la salud reconocida como líder en el tratamiento musculoesquelético, rehabilitación 
          deportiva y bienestar por parte de sus pacientes, empleados,  proveedores y todos los grupos de interés relacionados con 
          la actividad de la salud.`,
    mission: `Contribuir a la salud y bienestar de las personas poniendo a su disposición servicios de  máxima calidad asi
          ...
          a través de Physio Active  para la sociedad.`,
    values: [
        `Enfoque en el desarrollo del bienestar a largo plazo sin perder
        enfasis ante la necesidad de obtener continuamente resultados que nos permitan un crecimiento sólido.`,
        `Compromiso con prácticas y pasantias con Universidades  sostenibles que protejan a las generaciones futuras.`,
        `Marcar la diferencia en todo lo que hacemos gracias a la entereza por mejorar y por prestar un  servicio individual 
        de calidad con disciplina, rapidez y una ejecución de un  protocolo correcto`,
        `Facilitar el aporte de ideas, escuchando opiniones distintas  expresadas de forma abierta y sincera.`,
        `Compromiso con los pacientes con una sólida atencion basados en ética laboral, integridad, concentracion y cuidado, 
...
export const homeText = {
    welcomeTitle: "Bienvenido a Physio Active tu Centro de Fisioterapia y Kinesiologia",
    welcomeText: `Bienvenido a PHYSIO ACTIVE Somos un equipo de profesionales de la salud 
    dedicados a proporcionar atención personalizada y efectiva en fisioterapia y kinesiología. 
    Nuestro objetivo es ayudarte a recuperar tu salud y bienestar, e incorporarte a tus diferentes actividades 
    que desempeñes como también a alcanzar tu máximo potencial.`,
    helpTitle: "¿Como podemos ayudarte?",
    helpText: `En nuestra clínica, nos enfocamos en tratar a cada paciente de manera individualizada, teniendo en cuenta sus necesidades y objetivos únicos. Nuestros fisioterapeutas y kinesiólogos están altamente capacitados y experimentados en el diagnóstico y tratamiento de una amplia variedad de condiciones, desde lesiones deportivas, hasta dolores crónicos.
    Explora nuestra página web para conocer más sobre nuestros servicios, incluyendo:
    - terapia manual
    - electroanalgesia
    - ultrasonido
    - magnetoterapia y mas !!`,
    helpText2: `También puedes conocer a nuestro equipo, leer testimonios de nuestros pacientes satisfechos y obtener información sobre cómo prepararte para tu primera visita`,
